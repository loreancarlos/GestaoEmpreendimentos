...
import { cpfMask, phoneMask, unmaskValue, formatCPF, formatPhone } from '../utils/masks';
...
export function Clients() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setOperationError(error instanceof Error ? error.message : 'Erro ao salvar cliente');
    }
  };
  ...
  const confirmDelete = async () => {
    if (clientToDelete) {
      try {
        ...
        setOperationError(error instanceof Error ? error.message : 'Erro ao excluir cliente');
      }
    }
  };
